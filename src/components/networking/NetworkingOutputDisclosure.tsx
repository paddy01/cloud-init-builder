    ...
    <aside className="rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-blue-900">
      {editor ? (
        ...
        <p className="text-sm break-words">
          ...
          <a className="font-semibold underline focus:outline-none focus:ring-2 focus:ring-blue-500" href={NETWORK_CONFIG_GUIDANCE_URL} target="_blank" rel="noreferrer">Learn why</a>
        </p>
      )}
    </aside>
  );
